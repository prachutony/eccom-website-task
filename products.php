...
<div class="container" style="margin-top:65px">
    ...
    <hr/>
    <!--menu list-->
    <h5 class="pt-5" id="watch">Watches</h5>
    ...
    <hr>
    <h5 class="pt-5" id="shirt">Shirts</h5>
    <div class="row text-center">
        ...
        <hr>
        <h5 class="pt-5" id="shoes">Shoes</h5>
        <div class="row text-center">
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
            ...
            <hr>
            <h5 class="pt-5" id="headphones">Headphones</h5>
            <div class="row text-center">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
